...
class Crumblez_Model_BattlePointsAlliance extends Reusable_Model_Object_MyPresistable_Abstract 
{
	public $allianceId;
	public $time;
	public $points;
	...
	public static function getObjectId($playerId){
		$db = Reusable_Db_Registry::getDb();
		$select = $db->select()->from('battle_points_alliance','id')->where('alliance_id = ?',$playerId);
